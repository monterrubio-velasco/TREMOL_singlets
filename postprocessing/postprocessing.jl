...
# """
    ...
    vecMagniAval,vecNewAvalSpaceTime,VecMagSomerville,VecMai_Large,VecMai_VeryLarge,VecRamirez,VecArea = calcuMagniSpaceTimeSinglets(ik,datos,nbox_x,nbox_y,smin,VectorCenterAperities,VectorSaOriLateralSize_y, VectorSaOriLateralSize_x, CellSize,velAsp, Weff,Leff,pathresults,VecID)
    ...
    return vecMagniLoop,VecMagSomerville,VecMai_Large,VecMai_VeryLarge,VecRamirez,VecArea              
