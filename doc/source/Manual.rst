...
.. code-block:: julia
  ...
  include(joinpath("/PATH/TREMOL_singlets/preprocessing/","preprocessing.jl"))
...
These plots are save in the directory /PATH/TREMOL_singlets/Results_PlotsFiles.
...
Each row corresponds to a single test
