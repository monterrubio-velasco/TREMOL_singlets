...
YOURPATH = " "
pathresults = YOURPATH*"/TREMOL_singlets/TREMOL_singlets/Results_PlotsFiles/"    
include(joinpath(YOURPATH*"/TREMOL_singlets/TREMOL_singlets/postprocessing/","postprocessing.jl"))
using PyPlot
include("FBM_Singlets.jl")

function TREMOL_Singlets(VecID,fhi_asp,fhi_bkg,strength_asp,DurTeo,VelAsp,Leff,Weff,VectorSeff,SaOri,YsizeOri,nbox,nk,path)
...
#       Program that realize the post-process analysis               
        VecMagniLoop = postprocessing(datos,VectorCenterAperities,VectorSaOriLateralSize_y,VectorSaOriLateralSize_x,VectorCoordsAperities_x,VectorCoordsAperities_y,nbox_x,nbox_y, smin,vecEstadistico,VectorSaOri,SaOri[rij],totalNumberCells,a,cellSize,VelAsp[rij],Weff[rij],Leff[rij],DurTeo[rij],pathresults,VecID[rij])
