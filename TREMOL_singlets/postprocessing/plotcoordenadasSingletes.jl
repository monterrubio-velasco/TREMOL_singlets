...
#             if Velocidad[i,1]!=0
#               contNorm += 1
#               PyPlot.plot(log10.(TiempoAval[i,1]), log10.(Velocidad[i,1]), cl, markersize=nsi,alpha=0.5,label = "Normal(New-Group)")
#               PyPlot.hold("True")
#                if contNorm == 1
#                   PyPlot.legend(fontsize = 14,markerscale=4)
#               end
#             end
        end        
    end
 ...
 # ========================================================================================================
      ...
      PyPlot.figure(8839)
          for j=2:length(datos[:,1])
            ...
            # Plot las coordenadas espaciales de las AVALANCHAS en diferentes colores
                  ...
                  VecSize[ContFin]=l
                  AreaHB1 = CellSize # Area de la celda unitaria en km2 para tener un sismo de Magnitd Minima =2.0 HANKS and Bakun A>537
                  PyPlot.grid("on")
  ...
  #                   VecMagHB1[r] = 4.441 + (0.846*log10(VecAreaHB1[r]))
